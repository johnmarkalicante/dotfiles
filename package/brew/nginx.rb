class Nginx < Formula
  ...
  def install
    ...
    args = %W[
      ...
      --with-cc-opt=#{cc_opt}
      --with-ld-opt=#{ld_opt}
      --conf-path=/opt/dotfiles/settings/nginx/nginx.conf
      --pid-path=/opt/dotfiles/settings/nginx/run/nginx.pid
      --lock-path=/opt/dotfiles/settings/nginx/run/nginx.lock
      --http-client-body-temp-path=/opt/dotfiles/settings/nginx/run/client_body_temp
      --http-proxy-temp-path=/opt/dotfiles/settings/nginx/run/proxy_temp
      --http-fastcgi-temp-path=/opt/dotfiles/settings/nginx/run/fastcgi_temp
      --http-uwsgi-temp-path=/opt/dotfiles/settings/nginx/run/uwsgi_temp
      --http-scgi-temp-path=/opt/dotfiles/settings/nginx/run/scgi_temp
      --http-log-path=/opt/dotfiles/settings/nginx/log/access.log
      --error-log-path=/opt/dotfiles/settings/nginx/log/error.log
